...
class DeformConv2d(nn.Module):
    def __init__(self, inc, outc, kernel_size=3, padding=1, stride=2, bias=None, modulation=False):
        ...
        # 用于获取偏置项 卷积核的通道数应该为2 x kernel_size x kernel_size
...
if __name__ == '__main__':
    a = torch.randn(4, 80, 192, 192)
    model = DeformConv2d(inc = 80, outc = 160, kernel_size=3, padding=1, stride=2)
    out = model(a)
    print(out.shape)
...
#backbone:
  ...
  #  [-1, 1, DCNConv, [128, 3, 2]],  # 1-P2/4     -----替换在dark2的地方  160, 96, 96
  #  [-1, 3, C3, [128]],
  #  [-1, 1, Conv, [256, 3, 2]],  # 3-P3/8        -------  320,48,48
  #  [-1, 6, C3, [256]],
  #  [-1, 1, Conv, [512, 3, 2]],  # 5-P4/16      ---------  640,24,24
  #  [-1, 9, C3, [512]],
  #  [-1, 1, Conv, [1024, 3, 2]],  # 7-P5/32     ---------  1280,12,12
  #  [-1, 3, C3, [1024]],
  #  [-1, 1, SPPF, [1024, 5]],  # 9
  # ]