...
if __name__ == "__main__":
    ...
    #   默认指向根目录下的VOC数据集
    #-------------------------------------------------------#
    # VOCdevkit_path  = 'dataset/sirstv2_voc'
    # VOCdevkit_path  = 'dataset/VOCdevkit/VOC2007'
    VOCdevkit_path  = 'dataset/infobj_voc'
    # VOCdevkit_path  = 'dataset/sirst_voc'
    #-------------------------------------------------------#
    #   结果输出的文件夹，默认为map_out
    #-------------------------------------------------------#
    map_out_path    = 'result/map_out'
