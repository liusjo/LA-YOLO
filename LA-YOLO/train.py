...
# import wandb
# wandb.init(project="farcnn", entity="obj-det");

# 2674109 全套的 logs_xfpn_s
os.environ["CUDA_VISIBLE_DEVICES"] = "0,1"
# 3177005 中间用的原始的fpn logs_s

# 2006448 dcn+bi+fpn+head  logs_dcnb
# 2002439 dcn +fpn+head  logs_dcn

# 2034385 dcn+bi+ acm +head  logs_acm

# 1283811  dcnb + neckfine + dehead 全套voc

#  2027480 neckfine全套sisv2
...
if __name__ == "__main__":
    ...
    #---------------------------------------------------------------------#
    # classes_path    = 'model_data/inf_cla.txt'
    classes_path    = 'model_data/sis_cla.txt'
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = 'logs_swin_xfpn_head_x/best_epoch_weights.pth'
    ...
    #------------------------------------------------------#
    train_annotation_path   = 'dataset/sis1_train.txt'
    # train_annotation_path   = 'dataset/obj_train.txt'
    val_annotation_path     = 'dataset/sis1_test.txt'
    # val_annotation_path     = 'dataset/obj_test.txt'
